...
namespace lab3.NORTHWNDDataSetTableAdapters {
...
SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::lab3.Properties.Settings.Default.NORTHWNDConnectionString;
        }
        ...
        public virtual int FillByProductID(NORTHWNDDataSet.Order_DetailsDataTable dataTable, int ProductID) {
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBySupplierID(NORTHWNDDataSet.ProductsDataTable dataTable, global::System.Nullable<int> supplierID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
    ...
    public partial class SuppliersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT SupplierID, CompanyName FROM dbo.Suppliers WHERE CompanyName=@companyName\r" +
                "\n";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2].CommandText = "SELECT CompanyName, SupplierID FROM dbo.Suppliers WHERE SupplierID = @supplierID";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByCompanyName(NORTHWNDDataSet.SuppliersDataTable dataTable, string companyName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((companyName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBySupplierID(NORTHWNDDataSet.SuppliersDataTable dataTable, int supplierID) {
